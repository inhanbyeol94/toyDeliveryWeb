...
router.put('/restaurant/:restaurant_id/keyword', keywordController.updateKeyword);
router.delete('/restaurant/:restaurant_id/keyword', keywordController.deleteKeyword);
