...
function getRestaurant(restaurants, searchType, keyword) {
    ...
    for (let r of restaurants[0]) {
        ...
        let createHTML = `<div class="card storeCard m-3">
                                ...
                                <div class="keyword-list ms-3">
                                    <span class="badge rounded-pill text-bg-secondary">${[r.restaurant_keyword][0]}</span>
                                    <span class="badge rounded-pill text-bg-secondary">짬뽕</span>
                                    <span class="badge rounded-pill text-bg-secondary">탕수육</span>
                                </div>
                                </div>
